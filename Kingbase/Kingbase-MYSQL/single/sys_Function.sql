-- Kingbase MySQL compatibility initialization script for APIJSON Function.
-- Source: Kingbase-mysql/single/sys_Function.sql

SET standard_conforming_strings = on;

-- Kingbase MySQL 兼容模式 SQL
-- 转换自: MySQL/single/sys_Function.sql
-- 转换时间: 2026-05-10 20:57:50
