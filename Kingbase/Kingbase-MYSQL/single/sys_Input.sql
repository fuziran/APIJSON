-- Kingbase MySQL compatibility initialization script for APIJSON Input.
-- Source: Kingbase-mysql/single/Auto/UIGO/sys_Input.sql

SET standard_conforming_strings = on;

-- Kingbase MySQL 兼容模式 SQL
-- 转换自: MySQL/single/Auto/UIGO/sys_Input.sql
...
CREATE INDEX `idx_Input_index_time` ON `Input` (`time`);
CREATE INDEX `idx_Input_index_flowId` ON `Input` (`flowId`);
