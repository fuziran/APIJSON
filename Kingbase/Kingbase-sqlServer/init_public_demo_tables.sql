...
-- Run after init_public_apijson.sql against the apijson database:
-- jdbc:kingbase8://.../apijson?currentSchema=public

CREATE SCHEMA IF NOT EXISTS "public";

CREATE TABLE IF NOT EXISTS "public"."_Visit" (
...
CREATE TABLE IF NOT EXISTS "public"."apijson_user" (
  "id" BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."apijson_privacy" (
  "id" BIGINT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "idx_Moment_userId_date" ON "public"."Moment" ("userId", "date");
...
CREATE INDEX IF NOT EXISTS "idx_Comment_userId" ON "public"."Comment" ("userId");
CREATE INDEX IF NOT EXISTS "idx_Comment_momentId" ON "public"."Comment" ("momentId");
CREATE INDEX IF NOT EXISTS "idx_Comment_toId" ON "public"."Comment" ("toId");
...
DELETE FROM "public"."Access" WHERE "id" IN (6, 12, 13, 16, 17, 22, 24);
...
DELETE FROM "public"."Request" WHERE "id" IN (1, 2, 3, 4, 5, 6, 14, 15, 16, 17, 21, 23, 25, 28, 29, 30, 31, 36, 37, 39, 40, 41, 42, 43, 44);
...
DELETE FROM "public"."Function" WHERE "id" IN (10, 11, 12);
INSERT INTO "public"."Function" ("id", "debug", "userId", "language", "name", "returnType", "arguments", "demo", "detail", "version", "tag", "methods", "date", "return") VALUES
  ...
  (12, 0, 0, NULL, 'verifyURLList', NULL, 'array', '{"array": ["http://example.com/1.jpg"], "result()": "verifyURLList(array)"}', 'Verify URL list.', 0, NULL, NULL, '2019-08-17 19:58:33', NULL);

DELETE FROM "public"."apijson_user" WHERE "id" IN (38710, 70793, 82001, 82002, 82003, 93793);
INSERT INTO "public"."apijson_user" ("id", "sex", "name", "tag", "head", "contactIdList", "pictureList", "date") VALUES
...
DELETE FROM "public"."apijson_privacy" WHERE "id" IN (38710, 70793, 82001, 82002, 82003, 93793);
INSERT INTO "public"."apijson_privacy" ("id", "certified", "phone", "balance", "_password", "_payPassword") VALUES
...
DELETE FROM "public"."Moment" WHERE "id" IN (12, 15, 58, 170, 235, 301, 371, 470);
INSERT INTO "public"."Moment" ("id", "userId", "date", "content", "praiseUserIdList", "pictureList") VALUES
...
DELETE FROM "public"."Comment" WHERE "id" IN (4, 13, 22, 167, 176);
INSERT INTO "public"."Comment" ("id", "toId", "userId", "momentId", "date", "content") VALUES
...
DELETE FROM "public"."Verify" WHERE "id" IN (1623050785460);
INSERT INTO "public"."Verify" ("id", "type", "phone", "verify", "date") VALUES
  (1623050785460, 1, 13000082001, 8573, '2021-06-07 07:26:25');

DELETE FROM "public"."Login" WHERE "id" IN (1488616804093);
INSERT INTO "public"."Login" ("id", "userId", "type", "date") VALUES
  (1488616804093, 82001, 0, '2017-03-04 09:30:21');

DELETE FROM "public"."Praise" WHERE "id" IN (1);
INSERT INTO "public"."Praise" ("id", "userId", "momentId", "date") VALUES
  (1, 82001, 15, '2017-02-08 08:06:11');

DELETE FROM "public"."Response" WHERE "id" IN (1, 2, 3);
INSERT INTO "public"."Response" ("id", "method", "model", "structure", "detail", "date") VALUES
