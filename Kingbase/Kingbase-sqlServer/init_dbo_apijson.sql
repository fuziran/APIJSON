...
-- It creates the APIJSON framework tables referenced as "dbo"."Access" etc.
-- Run this against the apijson database used by:
-- jdbc:kingbase8://.../apijson?currentSchema=dbo

CREATE SCHEMA IF NOT EXISTS "dbo";

DROP TABLE IF EXISTS "dbo"."TestRecord" CASCADE;
DROP TABLE IF EXISTS "dbo"."Document" CASCADE;
DROP TABLE IF EXISTS "dbo"."Script" CASCADE;
DROP TABLE IF EXISTS "dbo"."Function" CASCADE;
DROP TABLE IF EXISTS "dbo"."Request" CASCADE;
DROP TABLE IF EXISTS "dbo"."Access" CASCADE;
...
CREATE INDEX "idx_Document_url" ON "dbo"."Document" ("url");
CREATE INDEX "idx_Document_date" ON "dbo"."Document" ("date");
...
CREATE INDEX "idx_Script_name" ON "dbo"."Script" ("name");
CREATE INDEX "idx_Script_simple" ON "dbo"."Script" ("simple");
